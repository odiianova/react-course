...
function transformJSX(ctx, path) {
  ...
  extractJSXExpressions(state, path, !(isPathValid(path.parentPath, t.isJSXElement) || isPathValid(path.parentPath, t.isJSXFragment) || isPathValid(path.parentPath, t.isJSXAttribute)));
