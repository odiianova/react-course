...
// node_modules/million/dist/shared/million.2a355d8b.mjs
var Object$ = Object;
var Map$ = Map;
var Set$ = Set;
...
// node_modules/million/dist/shared/million.5e1fca0a.mjs
...
var processProps = (props, ref, portals) => {
  ...
  for (const key in props) {
    ...
    if ((0, import_react2.isValidElement)(value) || Array.isArray(value) && value.length && (0, import_react2.isValidElement)(value[0])) {
...
var wrap = (vnode) => {
  return (0, import_react2.createElement)(RENDER_SCOPE, { suppressHydrationWarning: true }, vnode);
};
var renderReactScope = (vnode, unstable, portals, currentIndex) => {
  var _a;
  const el = (_a = portals == null ? void 0 : portals[currentIndex]) == null ? void 0 : _a.current;
  const isBlock = (0, import_react2.isValidElement)(vnode) && typeof vnode.type === "function" && "_c" in vnode.type;
...
var flatten = (rawChildren) => {
  if (rawChildren === void 0 || rawChildren === null)
    return [];
  if (typeof rawChildren === "object" && "type" in rawChildren && rawChildren.type === import_react2.Fragment) {
...
var block2 = (fn, options = {}) => {
  ...
  const MillionBlock = (props, forwardedRef) => {
    ...
    const vnode = (0, import_react2.createElement)(import_react2.Fragment, {}, marker, (0, import_react2.createElement)(Effect, {
      effect,
